...
private final CANSparkMax brazo = new CANSparkMax(23,MotorType.kBrushless);
Joystick cosito = new Joystick(0);
XboxController cosito2 = new XboxController(1);
...
public final CANSparkMax garrachavez = new CANSparkMax(32,MotorType.kBrushless);
  ...
  public void robotInit() {
    m_Encoder = garrachavez.getEncoder();
  ...
  public void teleopPeriodic() {
    ...
    drivetrain.arcadeDrive(cosito2.getLeftY()*(-1), cosito2.getRightX()*(-1));
   ...
   /* brazo.set(cosito.getZ());
    if(cosito2.getAButton()){
    brazo.set(0.5);
    }
    */
  }
